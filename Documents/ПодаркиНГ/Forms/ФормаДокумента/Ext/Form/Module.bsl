...
Функция ПолучитьГоды(Элемент, Прошедший, Следующий)
 	Годы = СтрРазделить(ЭтаФорма.ПодчиненныеЭлементы.Группа1.ПодчиненныеЭлементы.Годы.ТекстРедактирования, "/");
...
Функция ДописатьГоды(Прошедший, Следующий)
	//ЭтаФорма.ПодчиненныеЭлементы.Группа1.ПодчиненныеЭлементы.Годы = СтрЗаменить(Строка(Прошедший), Символы.НПП, "") + "/" + СтрЗаменить(Строка(Следующий), Символы.НПП, "");
